        ...
        <div className="container px-4 md:px-6 mx-auto">
          <div className="text-center mb-10">
            ...
            <p className="text-muted-foreground mt-4 max-w-[700px] mx-auto">
              Have questions about our programs? Reach out to us through any of
              these channels
            </p>
          </div>
          ...
          <div className="flex flex-wrap justify-center gap-4">
            ...
            <Link to="https://facebook.com/kaleem.institute" target="_blank" rel="noopener noreferrer">
              <Button variant="outline" className="gap-2">
          ...
          <div className="flex flex-col md:flex-row justify-between items-center gap-4 text-center md:text-left">
            <div>
              <p className="text-sm text-muted-foreground">
                © {new Date().getFullYear()} Kaleem Institute. All rights
                reserved.
              </p>
            </div>
