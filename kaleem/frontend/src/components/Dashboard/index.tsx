        ...
        <div className="mx-auto grid w-full max-w-6xl gap-6 md:grid-cols-2 lg:grid-cols-3">
          ...
          <Card>
            ...
            <CardContent>
              <ul className="space-y-4">
                <li>
                  <h3 className="font-semibold">New Resource Available</h3>
                  <p className="text-sm text-muted-foreground">
                    Additional reading materials for Data Structures have been
                    uploaded.
                  </p>
                </li>
                <li>
                  <h3 className="font-semibold">Guest Lecture</h3>
                  <p className="text-sm text-muted-foreground">
                    Join us for a special Web Development seminar next week.
                  </p>
                </li>
                <li>
                  <h3 className="font-semibold">Grading Update</h3>
                  <p className="text-sm text-muted-foreground">
                    Programming Assignment 1 grades have been posted.
                  </p>
                </li>
              </ul>
            </CardContent>
