	...
	return (
		<div className="min-h-screen bg-background text-foreground">
			...
			<section className="bg-gradient-to-b from-primary/10 to-background py-12 md:py-20">
				<div className="container mx-auto px-4 md:px-6">
					<div className="flex flex-col items-center space-y-4 text-center">
						<h1 className="font-bold text-3xl tracking-tighter md:text-5xl">{t(`About Kaleem Institute`)}</h1>
					...
					<div className="grid items-center gap-6 lg:grid-cols-2 lg:gap-12">
						<div className="space-y-4">
							<div className="inline-block rounded-lg bg-primary/10 px-3 py-1 text-sm">
								<BookOpenText className="mr-2 inline-block h-4 w-4" />
								{t(`Our Story`)}
							</div>
							<h2 className="font-bold text-3xl tracking-tighter md:text-4xl">{t(`About Kaleem Institute`)}</h2>
						...
						<Card className="border-none shadow-md">
							<CardHeader className="pb-2">
								<div className="mb-2 flex items-center gap-2">
									...
									<span className="font-medium text-primary text-sm">{t(`Our Purpose`)}</span>
								</div>
						...
						<Card className="border-none shadow-md">
							<CardHeader className="pb-2">
								<div className="mb-2 flex items-center gap-2">
									...
									<span className="font-medium text-primary text-sm">{t(`Our Aspiration`)}</span>
								</div>
			...
			<section className="py-12 md:py-16">
				<div className="container mx-auto px-4 md:px-6">
					<div className="mb-10 text-center">
						<h2 className="font-bold text-3xl tracking-tighter md:text-4xl">{t(`Our Core Values`)}</h2>
					...
					<div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
						<Card>
							<CardContent className="pt-6">
								...
								<h3 className="mb-2 font-bold text-xl">{t(`Academic Excellence`)}</h3>
								<p className="text-muted-foreground">
                  ...
                  through structured curriculum and qualified instructors.`)}
						...
						<Card>
							<CardContent className="pt-6">
								...
								<h3 className="mb-2 font-bold text-xl">{t(`Cultural Bridge`)}</h3>
								<p className="text-muted-foreground">
                  ...
                  language and Islamic traditions.`)}
						...
						<Card>
							<CardContent className="pt-6">
								...
								<h3 className="mb-2 font-bold text-xl">{t(`Accessibility`)}</h3>
								<p className="text-muted-foreground">
			...
			<section className="bg-muted/50 py-12 md:py-16">
				<div className="container mx-auto px-4 md:px-6">
					<div className="mb-10 text-center">
						<h2 className="font-bold text-3xl tracking-tighter md:text-4xl">{t(`What Our Students Say`)}</h2>
						<p className="mx-auto mt-4 max-w-[700px] text-muted-foreground">
						...
						<CarouselContent>
                          ...
                          lesson engaging."`)}
												...
												<div>
													...
													<p className="text-muted-foreground text-sm">{t(`Arabic & Quran Student`)}</p>
												</div>
											</div>
										</CardContent>
									</Card>
